...
function Skills() {
  ...
  const skills = [
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current">
          <path d="M15.337 2.543c-.222-.183-.558-.146-.863-.073l-.044.012c-.085.021-1.808.516-1.808.516s-1.154-1.118-1.279-1.243c-.128-.125-.365-.09-.464-.061-.007.003-.128.037-.334.103C10.38.985 10.038.347 9.46.347h-.037c-.323 0-.654.098-.974.285C7.94.92 7.568 1.45 7.306 2.176c-.472 1.304-.833 2.932-.833 2.932l-2.14.649c-.631.192-.65.212-.731.81C3.526 7.054 2 20.767 2 20.767L15.26 23l6.74-1.498S15.56 2.726 15.337 2.543zM11.48 3.147s-.632.191-1.41.429c.01-.4.01-.884-.051-1.32.534.074.987.444 1.46.89zm-1.82-.553c.074.452.074.975.054 1.425l-2.151.652c.21-.79.524-1.576.963-2.215.139-.202.35-.461.585-.608.23.234.423.494.55.746zm-.555-1.024c.096 0 .188.014.278.042-.294.188-.59.504-.811.84-.563.852-.976 2.019-1.145 3.183l-1.641.498c.334-1.573 1.548-4.434 3.319-4.563z" />
        </svg>
      ),
